...
import CadastrarAbastecimentoMobile2 from "../../pages/BaseConhecimento/img/CadastrarAbastecimentoMobile2.jpeg"
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 px-4 py-12">
            <div className="max-w-5xl mx-auto">
                <div className="mb-12">
                    <h1 className="text-5xl font-bold text-gray-900 mb-4">Abastecimentos Via SSX Mobile</h1>
