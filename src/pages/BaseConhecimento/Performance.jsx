        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 px-4 py-12">
            <div className="max-w-5xl mx-auto">
                ...
                <div className=" space-y-4 bg-white rounded-xl shadow-xl p-10 border border-slate-200 border-l-4 border-l-blue-500">
                    ...
                    <div className="space-y-2 bg-gray-50 p-4 rounded-lg border-l-4 border-gray-400 mb-6">
                        <p>
                        ...
                        <h2 className="font-bold text-xl" >Confira os passos para elaborar a avaliação de motoristas</h2>
                        <h2 className="font-bold text-xl" >1° Passo</h2>
                        <p>
                            Criar as regras que serão utilizadas para avaliar os motoristas sob o aspecto de direção segura.
                        </p>
                        <h2 className="font-bold text-xl" >2° Passo</h2>
                        <p>
                        ...
                        <h2 className="font-bold text-xl" >3° Passo</h2>
                        <p>
                            Criar a fórmula que vai avaliar o motorista.
                        </p>
                        <h2 className="font-bold text-xl" >3.1 Passo</h2>
                        <p>
                        ...
                        <h2 className="font-bold text-xl" >5.2 Passo</h2>
                        <p>
                        ...
                        <h2 className="font-bold text-xl">Mas Onde e Como a Gente Registra Essas Medidas Estruturais?</h2>
                        ...
                        <h2 className="font-bold text-xl" >7° Passo</h2>
                        <p>
                        ...
                        <h2 className="font-bold text-xl">Então temos: </h2>
                        <img src={PerformanceFormulaPontos} alt="" />
                        <h2 className="font-bold text-xl">Cálculo da Pontuação Final do Motorista:</h2>
                        <img src={PerformancePontuacaoFinal} alt="" />
                        <h2 className="font-bold text-xl">Avaliação Do Motorista No Aplicativo Onboard</h2>
