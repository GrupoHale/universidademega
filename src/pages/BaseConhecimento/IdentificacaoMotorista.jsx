export default function IdentificacaoMotorista() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 px-4 py-12">
            <div className="max-w-5xl mx-auto">
                <div className="mb-12">
                    <h1 className="text-5xl font-bold text-gray-900 mb-4">Identificação de Motorista</h1>
                ...
                <div className="bg-white rounded-xl shadow-xl p-10 border border-slate-200 border-l-4 border-l-blue-500">
                    <h2 className="text-2xl font-bold mb-6 text-blue-700">Sistema de Identificação</h2>
                    <p className="text-gray-700 mb-6 leading-relaxed text-lg">
                        Conheça como o sistema identifica e registra informações dos motoristas para rastreamento e gestão.
                    </p>
                    <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-300 mb-6">
                        <p className="text-gray-700 leading-relaxed font-medium">
                            Adicione seu conteúdo sobre identificação de motorista aqui.
                        </p>
                    </div>
                </div>
            </div>
