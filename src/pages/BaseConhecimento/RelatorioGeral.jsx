        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 px-4 py-12">
            <div className="max-w-5xl mx-auto">
                ...
                <div className=" space-y-4 bg-white rounded-xl shadow-xl p-10 border border-slate-200 border-l-4 border-l-blue-500">
                    ...
                    <div className="space-y-4 bg-gray-50 p-4 rounded-lg border-l-4 border-gray-400 mb-6">
                        ...
                        <h2 className="font-bold text-xl " >As colunas da grid desse relatório são:</h2>
                        <ul>
                        ...
                        <h2 className="font-bold text-xl">Observação Importante:</h2>
                        <p>
                        ...
                        <h2 className="font-bold text-xl">COLUNAS DO RELATÓRIO GERAL</h2>
